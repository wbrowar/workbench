...
new Vue({
    ...
    components: {
        ...
        AccordionTab = () => import('./components/AccordionTab.vue'),<% endif %>
        <% if (install.components.color_scheme_toggle) %>ColorSchemeToggle = () => import('./components/ColorSchemeToggle.vue'),<% endif %>
    },
    created: function () {
        // Watch resize
